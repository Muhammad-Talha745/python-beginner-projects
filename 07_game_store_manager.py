...
remove_game = input("Enter the game name that you want to remove: ")
remove_game = remove_game.capitalize()

remove_price = games.index(remove_game)
...
print("Games Above Rs. 30,000:", expensive_games)
